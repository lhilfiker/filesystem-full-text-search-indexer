...
// returns the extension of the file. Currently, it will determine that by the extension in the filename. It may be changed for a better detection in the future.
